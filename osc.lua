...
layouts["box"] = function ()
    ...
    lo.geometry = {x = posX, y = posY + 17, an = 5, w = osc_w, h = osc_h + 10}
    lo.layer = 10
...
--box左上角y坐标 posY - pos_offsetY 但an=5 元素中心点坐标和这个坐标一致，所以还要根据an=？加减元素的高度
    ...
    -- Seekbar
    --
	geo ={x = rjno1X + 1900 / 2 , y = rjno1Y + 20 , an = 5, w = 1900, h = 13}
...
--an = 5 时文字居中显示 往2边增加，所以一定要用1，这样多出的文字只会往右侧增长
	lo = add_layout("title")
    lo.geometry = {x = rjno1X +30, y = rjno1Y +5, an = 1, w = 500 - 30 * 3 * 7, h = 20}
    lo.style = osc_styles.rjno140Buttons	
...
--an = 1 这样左侧的时间变长才会往右，但y轴要调整
    ...
    lo.geometry = {x = rjno1X + 30, y = rjno1Y + 10 * 1.6 + 120 / 2, an = 1, w = 110, h = 20}
    lo.style = osc_styles.rjno140Buttons	
...
--an = 9 这样右侧的时间变长才会往左，但y轴要调整
    ...
    lo.geometry = {x = posX + pos_offsetX -190, y = rjno1Y + 10 * 1.6 + 80 / 2, an = 6, w = 110, h = 20}
    lo.style = osc_styles.rjno140Buttons	
...
--an = 1 图标最左侧才能点击
    ...
    lo.geometry = {x = posX+pos_offsetX - 110, y = rjno1Y + 10 * 1.6 + 80 / 2, an = 5, w = 30, h = 50}
    lo.style = osc_styles.rjno150Buttons	
--an = 1 图标最左侧才能点击
    lo = add_layout("tog_fs")
    lo.geometry = {x = posX+pos_offsetX - 60, y = rjno1Y + 10 * 1.6 + 80 / 2, an = 5, w = 30, h =50 }
    lo.style = osc_styles.rjno150Buttons
