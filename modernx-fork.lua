...
local user_opts = {
    ...
    titlefontsize = 24,             -- the font size of the title text
    ...
    OSCfadealpha = 80,             -- alpha of the background box for the OSC
    boxalpha = 200,                  -- alpha of the window title bar
    descriptionfontsize = 19,       -- alpha of the description background box
    descriptionBoxAlpha = 200,      -- alpha of the description background box
...
local language = {
    ['en'] = {
        welcome = '{\\fs24\\1c&H0&\\1c&HFFFFFF&}Mpv video player',  -- this text appears when mpv starts
        off = 'OFF',
        na = 'n/a',
        none = 'None available',
        video = 'Video',
...
layouts = function ()
    ...
    lo.geometry = {x = refX , y = refY - 70, an = 5, w = osc_geo.w - 50, h = 2}
    lo.layer = 13
    ...
    lo.geometry = {x = refX, y = refY - 70, an = 5, w = osc_geo.w - 50, h = 16}
    ...
    -- Title
  --  geo = {x = 25, y = refY - 100, an = 1, w = osc_geo.w - 50, h = 35}
  --  lo = add_layout("title")
  --  lo.geometry = geo
  ...
  --  end
    ...
    lo.geometry = {x = osc_geo.w - 145, y = refY - 40, an = 4, w = 80, h = 2}
    lo.layer = 13
    lo.alpha[1] = 128
    lo.style = osc_styles.VolumebarBg
    
    lo = add_layout('volumebar')
    lo.geometry = {x = osc_geo.w - 145, y = refY - 40, an = 4, w = 80, h = 8}
    ...
    lo.geometry = {x = 165, y = refY - 50, an = 7, w = 64, h = 20}
    lo.style = osc_styles.Time
        
    lo = add_layout('tc_right')
    lo.geometry = {x = osc_geo.w - 195 , y = refY - 50, an = 9, w = 64, h = 20}
    lo.style = osc_styles.Time
    ...
    lo.geometry = {x = osc_geo.w - 165, y = refY - 40, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
